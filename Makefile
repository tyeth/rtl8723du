...
clean:
	...
	@cd hal ; rm -fr */*.mod.c */*.mod */*.o */.*.cmd */*.ko *.d .*.cmd ; cd ..
	@cd hal/phydm/halrf ; rm -fr */*.mod.c */*.mod */*.o */.*.cmd */*.ko *.d .*.cmd ; cd ../../..
	@cd hal/phydm/halrf/rtl8723d ; rm -fr */*.mod.c */*.mod */*.o */.*.cmd */*.ko *.d .*.cmd ; cd ../../../..
	@cd hal/phydm/txbf ; rm -fr */*.mod.c */*.mod */*.o */.*.cmd */*.ko *.d .*.cmd ; cd ../../../
	@cd hal/efuse/rtl8723d ; rm -fr */*.mod.c */*.mod */*.o */.*.cmd */*.ko *.d .*.cmd ; cd ../../../
	@cd hal/phydm/rtl8723d ; rm -fr */*.mod.c */*.mod */*.o */.*.cmd */*.ko *.d .*.cmd ; cd ../../../
	@cd hal/rtl8723d/usb ; rm -fr */*.mod.c */*.mod */*.o */.*.cmd */*.ko *.d .*.cmd ; cd ../../../
	@cd hal/phydm ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d .*.cmd ; cd ../../
	@cd core ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d ; cd ..
	@cd core/crypto ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d ; cd ../../
	@cd core/monitor ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d ; cd ../../
	@cd core/mesh ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d ; cd ../../
	@cd core/wds ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d ; cd ../../
	@cd core/efuse ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d ; cd ../../
	@cd os_dep ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d ; cd ../
	@cd os_dep/linux ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d ; cd ../../
	@cd platform ; rm -fr *.mod.c *.mod *.o .*.cmd *.ko .*.d ; cd ../
